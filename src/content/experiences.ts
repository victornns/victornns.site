  ...
  pt: {
    ...
    items: [
      ...
      },
      {
        ...
        summary: [
          "Atuei no time de interface com foco em performance, responsividade, acessibilidade e fidelidade visual (pixel perfect). Desenvolvi sites institucionais, landing pages, e-mails marketing e CMS personalizados para diferentes clientes da agência.",
        ],
        technologies: [
          "SSR/SSG",
          "Vue.js",
      ...
      },
      {
        ...
        summary: [
          "Desenvolvimento e manutenção de sites institucionais, landing pages e CMS customizados com WordPress (Sage9/Understrap), além da sustentação de projetos legados.",
        ],
        technologies: [
          "WordPress",
          "Sage9",
      ...
      },
      {
        ...
        summary: [
          "Atuação focada em implementação de novas funcionalidades e manutenção de e-commerces na plataforma VTEX. Participei de entregas voltadas para performance e testes de estabilidade.",
        ],
      ...
      },
      {
        ...
        summary: [
          "Desenvolvimento de sites, blogs, e-mails marketing e landing pages. Contribuição no desenvolvimento e testes da Metlycs, plataforma de automação de marketing criada como produto próprio da agência.",
        ],
        technologies: [
          "HTML5",
          "CSS3",
  ...
  en: {
    ...
    items: [
      ...
      },
      {
        ...
        summary: [
          "Worked on the interface team focusing on performance, responsiveness, accessibility, and pixel-perfect visual fidelity. Developed institutional websites, landing pages, marketing emails, and custom CMS solutions for various agency clients.",
        ],
        technologies: [
          "SSR/SSG",
          "Vue.js",
      ...
      },
      {
        ...
        summary: [
          "Development and maintenance of institutional websites, landing pages, and custom CMS built with WordPress (Sage9/Understrap), as well as support for legacy projects.",
        ],
        technologies: [
          "WordPress",
          "Sage9",
      ...
      },
      {
        ...
        summary: [
          "Focused on implementing new features and maintaining e-commerce stores on the VTEX platform. Contributed to deliveries focused on performance and stability testing.",
        ],
        technologies: ["VTEX", "jQuery"],
      },
      {
        ...
        summary: [
          "Development of websites, blogs, marketing emails, and landing pages. Contributed to the development and testing of Metlycs, a marketing automation platform created as the agency's own product.",
        ],
        technologies: [
          "HTML5",
          "CSS3",
